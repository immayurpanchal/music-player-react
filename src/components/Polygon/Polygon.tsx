...
const Polygon2 = (props: React.SVGProps<SVGSVGElement> & PolygonProps) => {
	const { id, image, width = 46 } = props

	const height = width * (46 / 50)

	return (
		<svg fill='none' height={height} viewBox='0 0 46 50' width={width} xmlns='http://www.w3.org/2000/svg'>
			<path
